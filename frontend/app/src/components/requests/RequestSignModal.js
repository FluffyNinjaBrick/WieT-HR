    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          Wniosek o {DocumentType[props.type.toLowerCase()]}{" "}
          {typeof props.leave.leaveType !== "undefined"
            ? LeaveTypes[props.leave.leaveType].toLowerCase()
            : ""}
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {!signed ? (
          <div>
            ...
            <p>
              Czas trwania nieobecności: Od {props.leave.dateFrom} do{" "}
              {props.leave.dateTo}
            </p>
          </div>
        ) : (
