              ...
              <div className="mb-5">
                <BootstrapTable
                  ...
                  data={allDaysOff.map((daysOff) => {
                    ...
                    x.signLeaveButton = (
                        <div>  
                          <Button style={{ width: "100%", borderRadius: "0" }} onClick={() => setupModal(daysOff)}>Rozpatrz</Button>
                          <RequestSignModal
                ...
                <BootstrapTable
                  ...
                  data={allDelegations.map((delegation) => {
                    ...
                    x.signDelegationButton = (
                      <div>
                        <Button style={{ width: "100%", borderRadius: "0" }} onClick={() => setupModal(delegation)}>Rozpatrz</Button>
                        <RequestSignModal
